...
# Custom links take precedence. Otherwise, languages in pulling_from_transifex link to Transifex even if they have
# a repository; remaining languages link to their repository or, if unavailable, the general translation guide.
